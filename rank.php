...
<table style="width:100%"><th>
	...
	<form action="update.php" method="POST"style="display:flex;flex-direction:column">
	<label style="align:center">Enter Team-Ranking</label>
	
	<input type="number" name="rating" placeholder="129/130/..." style="display:block;margin:auto ">

	
	<label style="text-align:center">Enter-Name</label> 
	<input type="text" name="name" placeholder="RCB" align="padding-right"style="display:block;margin:auto ">
	</br>
	<button style="
  margin:auto">UPDATE</button></form>
</div></th></table>
...
<table style="vertical-align: text-top; width:100%"><tr><th>
	...
	<label>ENTER PLAYERNAME </label> 
 	<input type="text" name="name" placeholder="sehwag"><br>
	</label>ENTER RUNS</label>        <input type="number" name="runs" placeholder="211"><br/>
	<lebel>ENTER WICKETS  </label>      <input type="number" name="wickets" placeholder="23"><br>
	<label>ENTER NUMBER_OF_MATCHES </label>       <input type="number" name="no_of_matches" placeholder="176"><br>
